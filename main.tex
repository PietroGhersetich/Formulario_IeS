    ...
    \begin{itemize}
        ...
        \item \textbf{Stimatore "L.M.S"}:
              \begin{itemize}
                  ...
                  \item \textit{MSE}: $error(\hat{\Theta}_{LMS})=E[(\Theta-\hat{\Theta}_{LMS})^{2}]=Var[\Theta]$.
                        \begin{itemize}
        ...
        \item \textbf{Stimatore "L.M.S." lineare}:
              \begin{itemize}
                  ...
                  \item \textit{MSE lineare}: $MSE=E[(\Theta-\hat{\Theta}_{LIN})^2]=(1-\rho^{2}[X,\Theta])Var[\Theta]=(1-\frac{Cov^{2}[X,\Theta]}{Var[X]Var[\Theta]})Var[\Theta]$.
