    ...
    \begin{itemize}
        ...
        \item \textbf{Importance Sampling}
              \begin{itemize}
                  ...
                  \item $P_{X}(A)=E\left[\mathbbm{1}(X\in A)\right]=E\left[\underbrace{\mathbbm{1}(Y\in A)\frac{f_{X}(y)}{f_{Y}(y)}}_{g(Y)}\right]$.
                  \item Algoritmo:
                  \begin{algorithmic}[1]
